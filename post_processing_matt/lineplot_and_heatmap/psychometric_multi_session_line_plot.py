import sys
#sys.path.append('/post_processing_matt/utils')
sys.path.append('C:\\Users\\SJLab_Slice\\Documents\\photometry_analysis\\freely_moving_photometry_analysis\\post_processing_matt\\utils')
...
animalIDs = ['YJ_03'] #'SNL_photo68', 'SNL_photo69', 'SNL_photo70', 'SNL_photo71', 'SNL_photo72', 'SNL_photo73', 'SNL_photo74'
fibre_sides = ['right'] * len(animalIDs)
recording_site = 'striatum'
dates = ['20220405', '20220406', '20220407', '20220408', '20220411']
